...
# Installation
```bash
pip install "git+ssh://git@github.com/lambda-z/metora.git#subdirectory=packages/metora"
pip install "git+ssh://git@github.com/lambda-z/metora.git#subdirectory=packages/metora-django"
pip install "git+ssh://git@github.com/lambda-z/metora.git#subdirectory=packages/metora-beanie"
```
